package com.sl.springbootdemo.IdGenerate.snowflake;

import com.sl.springbootdemo.IdGenerate.snowflake.exception.UidGenerateException;
import com.sl.springbootdemo.IdGenerate.snowflake.utils.DateUtils;
import com.sl.springbootdemo.IdGenerate.snowflake.utils.IpUtils;
...
/**
 * 参考： https://github.com/johnhuang-cn/snowflake-uid
...
public class SnowflakeUidGenerator {
    ...
    public SnowflakeUidGenerator(long workerId) {
        this(workerId, DEFAULT_BASE_DATE, 28, 16, 19);
    }
     ...
     * xxx.yyy.zzz.ddd (转32位long,bit=24,保留低24位)
     *
