...
public class SynchroDemo01 {
    ...
    //代码块1（对象）this指的是当前对象
    public synchronized void accessResources01() {
        try {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 5; i++) {
            //new Thread(SynchroDemo01::accessResources0).start();
            new Thread(deno01::accessResources1).start();  //new Thread(() -> deno01.accessResources1()).start();
